	                    ...
	                    <div style="padding-top:30px" class="panel-body" >
	                        ...
	                        <form id="loginform" class="form-horizontal" role="form" action="../php/doctorlogin.php" method="post">
	                            ...
	                            <div style="margin-bottom: 25px" class="input-group">
	                                    ...
	                                    <div style="margin-bottom: 25px" class="input-group">
	                                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
	                                        <input id="login-email" type="ID Number" class="form-control" name="ID Number" value="" placeholder="ID Number" >
	                                    </div>
	                        ...
	                        <div class="panel-body" >
	                            <form id="signupform" class="form-horizontal" role="form" action="../php/doctorsignup.php" method="post">
	                                ...
	                                <div class="form-group">
	                                    ...
	                                    <div class="col-md-9">
	                                        <input type="email" class="form-control" name="email" placeholder="ID Number">
	                                    </div>
	                                </div>
	                                <div class="form-group">
